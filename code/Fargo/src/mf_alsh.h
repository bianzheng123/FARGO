...
namespace mf_alsh {
    ...
    public:
        Hash(Preprocess &prep_, Parameter &param_, const std::string &file, Partition &part_,
             const std::string &funtable);
    ...
    public:
        ...
        void
        knnF(Res *res_PQ, Hash &hash, Preprocess &prep, std::vector<int> **table, std::vector<bool> &flag_, int &size);
